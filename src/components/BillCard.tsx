          ...
          return (
            <>
              {activeItems.map((item) => (
                <div key={`active-${item.directusId || item.id}`} style={isEditing ? S.billItemEditable : S.billItem}>
              ...
              {crossedItems.length > 0 && (
                <>
                  ...
                  {crossedItems.map((item) => (
                    <div key={`crossed-${item.directusId || item.id}`} style={isEditing && !bill.addedToPOS ? S.billItemEditable : S.billItem}>
