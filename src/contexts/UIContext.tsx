...
export function UIProvider({ children }: { children: ReactNode }) {
  ...
  // Set data-theme on <html> so CSS custom properties resolve for the entire document,
  // including body background, browser chrome, and any portals rendered outside the app root.
  useEffect(() => {
