import { colors, radii, statusColors } from "./tokens";
...
export const S = {
  ...
  orderBar: {
    ...
    boxShadow: `0 -2px 12px ${colors.shadowMd}`,
  ...
  paymentSection: {
    ...
    background: colors.successBg,
    borderRadius: radii.lg,
    border: `1px solid ${statusColors.confirmed.border}`,
  },
  paymentLabel: {
    fontSize: 13,
    fontWeight: 600,
  ...
  loginCard: {
    ...
    maxWidth: 360,
    width: "100%",
    boxShadow: `0 4px 16px ${colors.shadowSm}`,
  },
  loginTitle: {
    fontSize: 24,
    fontWeight: 800,
