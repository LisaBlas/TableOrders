...
export function SplitEqualView() {
  ...
  const splitTitle = `Equal Split — Table ${table.resolveTableDisplayId(tableId)}`;
  const handleBack = () => {
  ...
  if (!isLargeScreen) {
    return (
      <div style={S.page}>
        <ScreenHeader title={splitTitle} left="back" onBack={handleBack} backDisabled={hasConfirmedPayments} />
